# <h1 align="center">Laporan Praktikum Modul 8 - ALGORITMA SEARCHIMG</h1>
...
untuk setiap karakter dalam kalimat hingga karakter null terminator (akhir string) dan menggunakan if statement untuk mengecek apakah huruf tersebut adalah huruf vokal atau bukan. jika huruf tersebut adalah huruf vokal maka jumlah vokal akan bertambah. kemudian kita membuat map vokal_map untuk menyimpan jumlah kemunculan setiap huruf vokal dalam kalimat yang diinputkan pengguna. Selanjutnya pada fungsi utama main kita membuat looping do-while yang didalamnya terdapat input kalimat yang diinputkan pengguna, kemudian kita memanggil fungsi hitung_vokal_2123 untuk menghitung jumlah huruf vokal dalam kalimat yang diinputkan pengguna. kemudian kita membuat map vokal_map untuk menyimpan jumlah kemunculan setiap huruf vokal dalam kalimat yang diinputkan pengguna. kemudian kita membuat looping for untuk setiap karakter dalam kalimat hingga karakter null terminator (akhir string) dan menggunakan if statement untuk mengecek apakah huruf tersebut adalah huruf vokal atau bukan. jika huruf tersebut adalah huruf vokal maka huruf tersebut akan dimasukkan kedalam map vokal_map. kemudian kita membuat looping for untuk setiap pasangan key-value dalam map vokal_map dan menampilkan huruf vokal dan jumlah kemunculannya dalam kalimat. kemudian kita membuat input ulangi_2123 untuk menanyakan apakah ingin mengulangi program atau tidak. kemudian kita membuat if statement untuk mengecek apakah pengguna ingin mengulangi program atau tidak. jika pengguna ingin mengulangi program maka program akan dilakukan looping. jika pengguna tidak ingin mengulangi program maka program akan berhenti.</br>
